...
class m210701_150045_insertDefaultsData extends Migration
{
    ...
    {
        $auth_users = [
            ['email'=> 'admin@admin.com',                                  'password' => md5('123465'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 1, 'company_id' => null],
            ['email'=> 'administracao@gaelehenryfilmagensme.com.br',       'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 2, 'company_id' => null],
            ['email'=> 'maria@hotmail.com',                                'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'financeiro@andersonebeneditajoalherialtda.com.br', 'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 2, 'company_id' => null],
            ['email'=> 'contato@sophieeyasminalimentosme.com.br',          'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 2, 'company_id' => null],
        ];
        ...
        $auth_user_company = [
            ['email'=> 'gael@filmagens.com',       'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 1],
            ['email'=> 'jose@filmagens.com',       'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 1],
            ['email'=> 'maria@filmagens.com',      'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 1],
            ['email'=> 'ana@filmagens.com',        'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 1],
            ['email'=> 'clodoaldo@filmagens.com',  'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 1],
            
            ['email'=> 'augusto@joalheria.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 2],
            ['email'=> 'sophie@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 2],
            ['email'=> 'yasmin@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 2],
            ['email'=> 'helena@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 2],

            ['email'=> 'rodrigo@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'josefa@Alimentos.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'pedro@Alimentos.com',      'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'claudio@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'matheus@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'igor@Alimentos.com',       'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
            ['email'=> 'lara@Alimentos.com',       'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 3, 'company_id' => 3],
        ];

        $common_users = [
            ['email'=> 'eliasbrandao@gmail.com',      'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'tania_rosangela@gmail.com',   'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'renata_dos_santos@gmail.com', 'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'lavinia@gmail.com',           'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'brendamonique@gmail.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'alamandaesilva@gmail.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'issaquiasmendonsa@gmail.com', 'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'barrosesilva@gmail.com',      'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'aparecidosantos@gmail.com',   'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'portomalu@gmail.com',         'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'dereckcantone@gmail.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'humbertosantos@gmail.com',    'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
            ['email'=> 'avrilcampinas@gmail.com',     'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => 4, 'company_id' => null],
