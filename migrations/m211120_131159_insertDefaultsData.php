...
class m211120_131159_insertDefaultsData extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $auth_users = [
            ['id'=>'2a6571da26602a67be14ea8c5ab82349', 'email'=> 'admin@admin.com',                                  'password' => md5('123456'), 'photo' => null, 'authKey' => \Yii::$app->security->generateRandomString(), 'acessToken' => \Yii::$app->security->generateRandomString(), 'user_type_id' => '89defae676abd3e3a42b41df17c40096', 'company_id' => null],
