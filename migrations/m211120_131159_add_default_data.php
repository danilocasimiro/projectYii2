...
class m211120_131159_add_default_data extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $auth_users = [
            ...
            ['id'=>'800c6ec313d47564f889c758a98f00d8', 'email'=> 'contato@sophieeyasminalimentosme.com.br',          'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Empresa', 'company_id' => null, 'friendly_id' => '5'],
        ];
        ...
        $auth_user_company = [
            ['id'=>'1f9ea80fefc61f650067ec3f341ea227', 'email'=> 'gael@filmagens.com',       'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'bdf6e74bf877e731093ed2dbeb2979f0', 'friendly_id' => '6'],
            ['id'=>'897236205e2d01f430ac8076f78abe1a', 'email'=> 'jose@filmagens.com',       'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'bdf6e74bf877e731093ed2dbeb2979f0', 'friendly_id' => '7'],
            ['id'=>'f2e927e48d6833b5d392ba644f5a750b', 'email'=> 'maria@filmagens.com',      'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'bdf6e74bf877e731093ed2dbeb2979f0', 'friendly_id' => '8'],
            ['id'=>'007e02ceaf6cfda74d5b7d231c915143', 'email'=> 'ana@filmagens.com',        'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'bdf6e74bf877e731093ed2dbeb2979f0', 'friendly_id' => '9'],
            ['id'=>'c109bf5509d2887a880f5b7da4197d52', 'email'=> 'clodoaldo@filmagens.com',  'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'bdf6e74bf877e731093ed2dbeb2979f0', 'friendly_id' => '10'],
            
            ['id'=>'0b688ea8acead3de7106dd915e32ac37', 'email'=> 'augusto@joalheria.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'c00e71d1594cf57a55b0d6a3416cf555', 'friendly_id' => '11'],
            ['id'=>'a60d29b7e7b6665763a7fd10393e37ba', 'email'=> 'sophie@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'c00e71d1594cf57a55b0d6a3416cf555', 'friendly_id' => '12'],
            ['id'=>'cb8a59b7de9ddfee17ddb6ae8b2110bd', 'email'=> 'yasmin@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'c00e71d1594cf57a55b0d6a3416cf555', 'friendly_id' => '13'],
            ['id'=>'cd51c1b996fce8efc404091db83e02af', 'email'=> 'helena@joalheria.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => 'c00e71d1594cf57a55b0d6a3416cf555', 'friendly_id' => '14'],

            ['id'=>'6d10e1f081a5621844916d361eb995c2', 'email'=> 'rodrigo@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '15'],
            ['id'=>'a60e888c42a57b615a48b3029b991231', 'email'=> 'josefa@Alimentos.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '16'],
            ['id'=>'2b2a8880fe12e93c751cc50fe0031868', 'email'=> 'pedro@Alimentos.com',      'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '17'],
            ['id'=>'d4f6064ff6ad6cafbad64d98cfee611e', 'email'=> 'claudio@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '18'],
            ['id'=>'623f5dd324577eb7b4df87f0d8ceffda', 'email'=> 'matheus@Alimentos.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '19'],
            ['id'=>'803db9ef98eb9a013f049cee16c31166', 'email'=> 'igor@Alimentos.com',       'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '20'],
            ['id'=>'9328874a0cac6034ad5608463c0cfac2', 'email'=> 'lara@Alimentos.com',       'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Colaborador', 'company_id' => '9b62efa1a31d51566996be1646445fb9', 'friendly_id' => '21'],
        ];
       
        $common_users = [
            ['id'=>'0f75899958ce8c22144bec8f12761504', 'email'=> 'eliasbrandao@gmail.com',      'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '22'],
            ['id'=>'7ac6ea2f50a9cdf3b5b3d0539d323b4c', 'email'=> 'tania_rosangela@gmail.com',   'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '23'],
            ['id'=>'a9496cbef6cbcb20a6efc251f80469df', 'email'=> 'renata_dos_santos@gmail.com', 'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '24'],
            ['id'=>'9eb951b304769272bd87bb72e4c5cfd8', 'email'=> 'lavinia@gmail.com',           'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '25'],
            ['id'=>'599c011241c045b0b7e55dfe7d6693a8', 'email'=> 'brendamonique@gmail.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '26'],
            ['id'=>'32b269312326573ef3f2d7bf586a7bcf', 'email'=> 'alamandaesilva@gmail.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '27'],
            ['id'=>'c12e01f2a13ff5587e1e9e4aedb8242d', 'email'=> 'issaquiasmendonsa@gmail.com', 'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '28'],
            ['id'=>'b5241b4630506e90ecf9d060c28b92c3', 'email'=> 'barrosesilva@gmail.com',      'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '29'],
            ['id'=>'437b48cb25502822baa7e252ea1213c9', 'email'=> 'aparecidosantos@gmail.com',   'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '30'],
            ['id'=>'fd8fc985019572a9be30158853b82856', 'email'=> 'portomalu@gmail.com',         'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '31'],
            ['id'=>'551f18baed9001a464f5933b9b348046', 'email'=> 'dereckcantone@gmail.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '32'],
            ['id'=>'9a3ca8506b81873645a4d4435df393df', 'email'=> 'humbertosantos@gmail.com',    'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '33'],
            ['id'=>'37ffdb2ade7430762ea471dc3ad6400a', 'email'=> 'avrilcampinas@gmail.com',     'password' => md5('123456'), 'photo' => null, 'auth_key' => \Yii::$app->security->generateRandomString(), 'access_token' => \Yii::$app->security->generateRandomString(), 'type' => 'Usuário', 'company_id' => null, 'friendly_id' => '34'],
        ...
        \Yii::$app->db
        ->createCommand()
        ->batchInsert('auth_users',  ['id', 'email', 'password', 'photo', 'auth_key', 'access_token', 'type', 'company_id', 'friendly_id'], $auth_users)
        ->execute();
        ...
        \Yii::$app->db
        ->createCommand()
        ->batchInsert('auth_users', ['id', 'email', 'password', 'photo', 'auth_key', 'access_token', 'type', 'company_id', 'friendly_id'], $auth_user_company)
        ->execute();

        \Yii::$app->db
        ->createCommand()
        ->batchInsert('auth_users', ['id', 'email', 'password', 'photo', 'auth_key', 'access_token', 'type', 'company_id', 'friendly_id'], $common_users)
        ->execute();
